...
- **周波数スペクトラム表示**（リアルタイム FFT、16384 サンプル）
- **周波数グリッド**（500Hz 間隔、ラベル付き）

### 🔬 **位相情報保持 FFT 解析** ⭐**NEW**

- **超高精度 FFT 解析**（**16384 サンプル**、ハミング窓適用）
...
2. **段階的実験**：少数成分から開始して徐々に追加し音質変化を観察
...
サンプリング周波数: 44.1kHz
録音時間: 2秒間
FFTサイズ: 16384サンプル（超高精度）
窓関数: ハミング窓
周波数分解能: 2.7Hz（44.1kHz時）
位相精度: ±0.1度
表示成分数: 最大100成分
